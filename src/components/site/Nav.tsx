  ...
  return (
    <header className="sticky top-0 z-40 border-b-4 border-dashed border-foreground/20 bg-background/90 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-6 px-6 py-3">
        ...
        <nav className="retro hidden items-center gap-6 text-[10px] tracking-wider uppercase text-muted-foreground sm:flex">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="retro hidden text-[9px] tracking-wider uppercase text-muted-foreground hover:text-foreground sm:inline"
          >
            by SriNath →
          </a>
